...
* feat(integrations): port OpenAI W- Implements profiling support for IPUs by @camer- Fixes conditions order of `_to_dict` helper by @dmitryduev in [https://github.com/wandb/wandb/pull/3772](https://github.com/wandb/wandb/pull/3772)
- Fixes changelog broken link to PR 3709 by @janosh in [https://github.com/wandb/wandb/pull/3786](https://github.com/wandb/wandb/pull/37- Fix launch permission error by @KyleGoyette in [https://github.com/wandb/wandb/pull/3038](https://github.com/wandb/wandb/pull/3038)

**Full Changelog**: [https://github.com/wandb/wandb/compare/v0.12.7...v0.12.8](https://github.com/wandb/wandb/compare/v0.12.7...v0.12.8)
- Fixes public api query (QueuedJob Api) by @KyleGoyette in [https://github.com/wandb/wandb/pull/3798](https://github.com/wandb/wandb/pull/3798)artin in [https://github.com/wandb/wandb/pull/3897](https://github.com/wandb/wandb/pull/3897)
#### :bug: Bug Fix
- Fixes sweep agent with service by @raubitsj in [https://github.com/wandb/wandb/pull/3899](https://github.com/wandb/wandb/pull/3899)
- Fixes an empty type equals invalid type and how artifact dictionaries are handled by @KyleGoyette in [https://github.com/wandb/wandb/pull/3904](https://github.com/wandb/wandb/pull/3904)Logger for openai-python v1.0 by @ayulockin in https://github.com/wandb/wandb/pull/6498

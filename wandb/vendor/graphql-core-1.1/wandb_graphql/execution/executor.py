...
from ..type import (GraphQLEnumType, GraphQLInterfaceType    """
    ...
    if completed is None and return_type.of_type:
        raise GraphQLError(
            'Cannot return null for non-nullable field {}.{} with inner type {}.'.format(info.parent_type, info.field_name, return_type.of_type),
            field_asts
        )

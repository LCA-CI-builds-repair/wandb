...
config\_project = launch\_config.get("project")
project = config\_project or source\_uri or ""
if entity is None:
config\_entity = None
if launch\_config:
config\_entity = launch\_config.get("entity")
entity = config\_entity or api.default\_entity
prefix = ""

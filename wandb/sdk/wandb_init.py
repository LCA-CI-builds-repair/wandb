...
class _WandbInit:
    ...
    def teardown(self) -> None:
        ...
        import logging  # Add necessary import statements if required
        logger = logging.getLogger(__name__)  # Ensure proper handling of logger
        assert logger
        logger.info("tearing down wandb.init")
        for hook in self._teardown_hooks:
            hook()  # Correct the method call to hook
